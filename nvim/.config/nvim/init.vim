...
nnoremap <silent><nowait> <space>p  :<C-u>CocListResume<CR> inoremap <silent><nowait><expr> <C-b> coc#float#has_scroll() ? "\<c-r>=coc#float#scroll(0)\<cr>" : "\<Left>"
  vnoremap <silent><nowait><expr> <C-f> coc#float#has_scroll() ? coc#float#scroll(1) : "\<C-f>"
  vnoremap <silent><nowait><expr> <C-b> coc#float#has_scroll() ? coc#float#scroll(0) : "\<C-b>"
endif
...
" DWM RELATED "
autocmd BufWritePost ~/Downloads/dwm_pkgs/dwmblocks/config.h !cd ~/Downloads/dwm_pkgs/dwmblocks/;
