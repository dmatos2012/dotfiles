...
vim.api.nvim_set_keymap("n", "<space>rs", '<cmd>lua require("david.repl").set_job_id()<CR>', { noremap = true })
vim.api.nvim_set_keymap("n", "<space>rc", '<cmd>lua require("david.repl").set_job_command()<CR>', { noremap = true })
vim.api.nvim_set_keymap("n", "<space>ri", '<cmd>lua require("david.repl").send_to_term()<CR>', { noremap = true })
