...
vim.cmd [[nnoremap ,snl :call luaeval("require('david.repl').send_repl_line()")<CR>]]
vim.cmd [[vnoremap ,snl :call luaeval("require('david.repl').send_repl_selection()")<CR>]]
