...
# Create a hook to activate the virtualenv when entering the directory
...
#          }
#          code: "print $after; overlay use venv/bin/activate.nu"
#      }
# 
#      {
#          condition: {|before, after|
#              ($before != null
#                  and ($before | path join venv | path exists)
#                  and 'activate' in (overlay list))
#          }
#          code: "print deactivate;overlay hide activate --keep-env [PWD]"
#      }
#  ]
# })
